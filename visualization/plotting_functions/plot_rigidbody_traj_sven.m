function plot_rigidbody_traj(R_FS_demo,R_FS_recon,R_demo,p_obj_demo,R_recon,p_obj_recon,constraints,title)
...
lency = 0.15*scale; % length of cube
lencz = 0.07*scale; % length of cube
