...
if show_demonstration
    [tim, measured_pose_coordinates] = load_vive_data_2('../data/demonstrated_trajectories/test_pouring.csv');
...
for j = 0:0
[robot_times,robot_trajectory] = load_trajectory([results_folder, 'traj',num2str(j),'.txt']);
...
plot_trajectory(robot_trajectory, [], 'generated trajectory',1,show_obstacle);
