function plot_RBT_3D_compare_robotmodel(T_demo,T_recon,titel,view_angles,adapt,halflength_position_coordinates,q,showdemo)
...
save_frames = 1;
    if(save_frames)
        ...
        export_fig(['figures/sinus_workspace_' num2str(teller) '.png'],'-m1.5')
