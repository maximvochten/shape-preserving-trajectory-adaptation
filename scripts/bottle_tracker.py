...
if __name__ == '__main__':
    ...
    rospy.init_node('bottle_tracker', anonymous=True)
    bottle_pose = rospy.Publisher("bottle_pose_pub", Pose, queue_size=1)
    ...
    while not rospy.is_shutdown():
        ...
        bottle_msg = tf_c.toMsg(tf_c.fromTf(T_b_t))
        ...
        bottle_pose.publish(bottle_msg)
